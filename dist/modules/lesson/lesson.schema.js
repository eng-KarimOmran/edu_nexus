...
exports.UpdateLessonSchema = exports.ChangeLessonStateSchema = exports.GetLessonDetailsSchema = exports.GetAllLessonsSchema = exports.CreateLessonSchema = void 0;
...
exports.UpdateLessonSchema = {
    ...
    body: zod_1.default.object({
        startTime: common_validation_1.futureDate.optional(),
        transmission: common_validation_1.transmission.optional(),
        expectedPaymentAmount: common_validation_1.price.optional(),
