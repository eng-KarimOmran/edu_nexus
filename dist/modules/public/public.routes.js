...
const public_controller_1 = __importDefault(require("./public.controller"));
const Schema = __importStar(require("./public.schema"));
const validate_middleware_1 = __importDefault(require("../../shared/middlewares/validate.middleware"));
const router = (0, express_1.Router)({ mergeParams: true });
router.get("/", (0, validate_middleware_1.default)(Schema.GetAcademySchema), public_controller_1.default.getAcademy);
